...
<div id="featured-content"<?php if($count>1): ?> class="withSlider"<?php endif; ?>>
 <?php if($valid_featured_posts): // only show if the global variable is set in the function above ?>
 <!-- block container -->
 ...
 <!-- /block container -->
 <?php else: ?>
 <h4><?php printf(__("No featured posts found older than %s days.", "mystique"), get_mystique_option('featured_timeframe')); ?></h4>
 <?php endif; ?>
</div>
