...
function mystique_credit(){
  return sprintf(__('Mystique2 theme by <a href="http://www.mattytemple.com">Matthew Temple</a> | Powered by %3$s', 'mystique'), '<abbr title="'.THEME_NAME.'/'.THEME_VERSION.'">Mystique2</abbr>','<a href="http://www.mattytemple.com">Matthew Temple</a>', '<a href="http://wordpress.org/">WordPress</a>');
}
